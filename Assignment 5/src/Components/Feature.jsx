...
function Feature() {
    ...
    return (
        <div className="p-4">
            <h2 className="text-2xl font-bold text-center text-white mt-[10%]">Now Playing</h2>
            <div className="flex flex-wrap justify-center gap-18">
                {movies.map((movie) => (
                    <div key={movie.id} className="mt-[5%] w-[15%] h-[auto] bg-blue-900 text-white rounded-lg overflow-hidden shadow-lg">
