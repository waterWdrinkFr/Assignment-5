    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[120px] bg-gradient-to-b from-black to-transparent z-20">
            <div className="flex items-center h-full">
                ...
                <button className="mt-0.5 ml-37.5 h-[35px] w-[70px] p-1 rounded-lg text-xs font-bold text-white bg-blue-900 cursor-pointer">
                    LOGIN </button>
                <button className="mt-0.5 ml-5 h-[35px] w-[90px] p-1 rounded-lg text-xs font-bold text-white bg-blue-900 cursor-pointer">
                    REGISTER </button>
            </div>
        </div>
    );
